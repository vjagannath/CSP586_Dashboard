...
var FilterMenu = function () {
    ...
    FilterMenu.prototype.remove = function () {
        this.th.removeChild(this.menu);
    };
...
var FilterCollection = function () {
    ...
    FilterCollection.prototype.remove = function () {
        this.filterMenus.forEach(function (filterMenu) {
            filterMenu.remove();
        });
    };
...
class DropDownFilter {
    constructor(target, options) {
        this.target = target;
        this.options = options;
        if (typeof options.columnSelector === 'undefined') this.options.columnSelector = '';
        if (typeof options.sort === 'undefined') this.options.sort = true;
        if (typeof options.search === 'undefined') this.options.search = true;
        if (typeof options.captions === 'undefined') this.options.captions = {
            a_to_z: 'A to Z',
            z_to_a: 'Z to A',
            search: 'Search',
            select_all: 'Select All'
        };
        this.filterCollection = new FilterCollection(this.target, this.options);
        this.filterCollection.initialize();
    }

    refresh(target) {
        this.target = target;
        this.filterCollection.remove();
        this.filterCollection = new FilterCollection(this.target, this.options);
        this.filterCollection.initialize();
    }
}
